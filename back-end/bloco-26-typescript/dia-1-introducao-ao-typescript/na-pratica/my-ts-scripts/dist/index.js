...
const scripts = [
    { name: "Checagem de estação", script: "./seasonCheck" },
...
const choice = readline_sync_1.default.keyInSelect(scriptNames, "Escolha um número para executar o script desejado");
