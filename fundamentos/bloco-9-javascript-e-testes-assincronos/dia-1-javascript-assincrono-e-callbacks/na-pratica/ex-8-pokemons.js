...
function messagePrinter(error, message) {
  if (error) {
...
getPokemonDetails((pokemon) => pokemon.name === 'Char', messagePrinter);
getPokemonDetails((pokemon) => pokemon.name === 'Bulbasaur', messagePrinter);
